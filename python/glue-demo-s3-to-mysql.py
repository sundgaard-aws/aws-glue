...
# start job
logger.info("starting glue-demo-iac job...")
## @params: [JOB_NAME]
...
def get_secret(secret_name):
    #secret_name = "dev/glue-demo-carsdb"
...
secretsManagerEntry = get_secret2("dev/glue-demo-carsdb")
